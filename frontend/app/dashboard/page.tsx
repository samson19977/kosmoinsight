...
export default function DashboardPage() {
  ...
  if (error) return <div style={{ padding: 20, color: "#E24B4A", background: "#FCEBEB", borderRadius: 10, fontSize: 14 }}>⚠ Could not load dashboard: {error}<br /><small>Make sure the backend API is running and NEXT_PUBLIC_API_URL is set correctly.</small></div>;
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <Card title="🤖 AI Insights">
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {insights.length === 0 ? <p style={{ color: "#888", fontSize: 14 }}>No insights yet. Add data to get started.</p>
