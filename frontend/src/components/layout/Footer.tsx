      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-2">
          ...
          <div className="mt-5 space-y-2 text-sm">
            <a href="mailto:digital@example.com" className="flex items-center gap-2 text-gray-400 hover:text-primary-400 transition-colors">
              <Mail size={14} /><span>digital@example.com</span>
            </a>
